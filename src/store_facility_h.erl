...
init(Req0, Opts) ->
	...
	%in an array.
	Facility_Info = jsx:decode(Data),
    Pid = r_r:get_next(store_facility_rr),
	Facility_Id = maps:get("facility_uuid",Facility_Info),
    Results = jsx:encode(store_facility_info:set_info(Pid,Facility_Id,Facility_Info)),
